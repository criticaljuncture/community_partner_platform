...
ActiveRecord::Schema.define(version: 20130929205639) do
  ...
  add_index "community_partnership_grade_levels", ["community_partnership_id", "grade_level_id"], name: "cpgl_cpid_glid", using: :btree
  add_index "community_partnership_grade_levels", ["grade_level_id", "community_partnership_id"], name: "cpgl_glid_cpid", using: :btree
